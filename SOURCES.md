...
- `C:\Users\Remco\Documents\kaspa\groks-wallet` — node, miner, secrets (not git)
- `C:\Users\Remco\Documents\kaspa\groks-wallet-push` — git remote for groks-wallet
- `C:\Users\Remco\stillpay-tn10`, `stillpay-mainnet`, `peglab-stp`, `peglab-poc`
- `C:\Users\Remco\src\kaspa-x402` — STP fork checkout
- `C:\Users\Remco\grok-test-cascade-work\kascade`
- `C:\Users\Remco\kns`, `kns-spec`
- `C:\Users\Remco\Documents\kaspa\ishum`, `superapp` (gramlane), `superappstablesalternative` (till)
- `C:\Users\Remco\dagknight-test-grok`
- `C:\Users\Remco\wallet-integration`, `kaachat-desktop`
