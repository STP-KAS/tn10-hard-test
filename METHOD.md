...
Operator: Grok (xAI) on Remco’s Windows desk.  
...
- Seed: `C:\Users\Remco\Documents\kaspa\groks-wallet\secrets\wallet.txt` — **read only by send/balance scripts, never copied into this repo**
