...
| kns / groks-wallet absolute `C:\Users\Remco\...` paths | Username + layout in public source. Not a key. Use env vars. |
...
| Finding | Notes |
| --- | --- |
| LinkedIn / local paths in project-delusional README | Human identity + `C:\Users\Remco\...` in a public README. Not a key. Decide if the desk path catalog belongs on GitHub. |
| `kaspa-data-vault` | Local Go module `github.com/remco/kaspa-data-vault` with `testdata/secret.txt`. **Not** in the 36 public GitHubs. Keep it that way unless the secret is a fixture. |
